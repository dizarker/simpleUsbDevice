...
vlog -work work clkSrc_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax clkSrc_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.clkSrc_tb work.glbl
