...
xst -ifn xst.scr
move clkSrc_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkSrc_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkSrc_exdes.ucf clkSrc_exdes

echo 'Running map'
map -timing -pr b clkSrc_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clkSrc_exdes -w routed.ncd routed.v
cd ..
